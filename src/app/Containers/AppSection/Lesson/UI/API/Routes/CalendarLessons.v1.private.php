...
use App\Containers\AppSection\Lesson\UI\API\Controllers\CalendarLessonsController;
use Illuminate\Support\Facades\Route;

Route::get('lessons/calendar', [CalendarLessonsController::class, 'calendarLessons'])
    ->middleware(['auth:api']);
