...
use App\Containers\AppSection\Invitation\UI\API\Controllers\AcceptInvitationController;
use Illuminate\Support\Facades\Route;

Route::post('invitations/{id}/accept', [AcceptInvitationController::class, 'acceptInvitation'])
    ->middleware(['auth:api']);
